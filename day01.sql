...
ogreci_tc char(11), 		 -- Uzunlugu belli olan String veriler icin char() data turu kullanılır.
...
--SORU: ogretmenler isminde tablo olusturalım
...
-- SORU: ogretmenler tablosuna veri girisi yapalım
